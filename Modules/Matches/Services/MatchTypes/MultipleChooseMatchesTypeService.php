...
class MultipleChooseMatchesTypeService implements Interfaces\IMatchesTypeService
{
    use TsearchQueries;
    use TviewQueries;
    use Tmatch;
    ...
    {
        return [
            'companies' => $this->multipleValueOptionStatistics($match->id, MatchesProfile::$company),
            'professionals' => $this->multipleValueOptionStatistics($match->id, MatchesProfile::$professional),
        ];
    }
